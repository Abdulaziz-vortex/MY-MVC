        ...
        <div class="row">
            <div class="container m-auto">
                <div class="navbar navbar-expand navbar-light pl-0 pr-0">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a href="/galery/photos" class="nav-link">Photos</a></li>
                        <li class="nav-item"><a href="/galery/videos" class="nav-link">Videos</a></li>
                    </ul>
                    ...
                    <?php foreach($photos as $n):?>
                        <div class="col-lg-4"> 
                            ...
                            <li class="list-group-item shadow-sm border-0 mb-3">
                                ...
                                <div class="mb-3 text-muted"><span class="mr-3"><i class="fas fa-calendar mr-1"></i><?=$n['date']?></span><span><i class="fas fa-tag mr-1"></i><?=$n['category']?></span></div>
